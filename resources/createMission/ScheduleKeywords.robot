...
Add break time button
    Click Element [Arguments] xpath=//*[@id="root"]/div[2]/div/div/div/div/div/div[3]/div/div/div[4]/div[1]/div/button ${SMALL_RETRY_COUNT}

Add interval button
    Click Element [Arguments] xpath=//*[@id="root"]/div[2]/div/div/div/div/div/div[3]/div/div/div[4]/div[1]/div/div[1]/button ${SMALL_RETRY_COUNT}
