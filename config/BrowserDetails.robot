...
*** Variables ***
# Extecution Browser
${COMMON_OPTS}              add_argument("--lang=fr");add_experimental_option("prefs", {"intl.accept_languages": "fr"});add_argument("--headless");add_argument("--no-sandbox");add_argument("--disable-dev-shm-usage")
...
${BROWSER}                  chrome
${LOCAL_BROWSER_OPTIONS}    add_argument("--lang=fr");add_experimental_option("prefs", {"intl.accept_languages": "fr"});
