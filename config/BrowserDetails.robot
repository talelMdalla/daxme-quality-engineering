...
${COMMON_OPTS}              ${LANGUAGE_SETTINGS}add_argument("--headless");add_argument("--no-sandbox");add_argument("--disable-dev-shm-usage");add_argument("--window-size=1920,1080");add_argument("--force-device-scale-factor=1");
